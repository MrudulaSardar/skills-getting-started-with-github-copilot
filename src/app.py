...
activities = {
    ...
    "Drama Club": {
        "description": "Rehearse scenes, develop acting skills, and perform school plays",
    ...
    "Science Club": {
        "description": "Explore experiments and science projects across biology, chemistry, and physics",
